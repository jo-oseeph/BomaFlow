...
export default function SignupPage() {
  ...
  async function onSubmit(raw: SignupForm) {
    ...
    try {
      ...
      setAuthError(error instanceof Error ? error.message : 'Unable to create account. Please try again.')
    }
  }
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-muted">
          Join BomaFlow to browse listings, apply for rentals, and manage your profile.
        </p>
      </div>
      ...
      <p className="mt-8 text-center text-sm text-muted">
        ...
        <Link to="/login" className="font-semibold text-gold hover:text-gold-light">
          Sign in
        </Link>
      </p>
